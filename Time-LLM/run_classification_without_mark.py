...
for ii in range(args.itr):
    ...
    for epoch in range(args.train_epochs):
        ...
        vali_loss, vali_mae_loss = vali(args, accelerator, model, vali_data, vali_loader, criterion, metric)
        test_loss, test_mae_loss = vali(args, accelerator, model, test_data, test_loader, criterion, metric)
        accelerator.print(
