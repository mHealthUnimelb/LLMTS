...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_split_path', type=str, help='data split index file')
    ...
    parser.add_argument('--num_ca_heads', type=int, default=1)
    ...
    # print(f"Arg learn_emb: {args.learn_emb}, type: {type(args.learn_emb)}")
