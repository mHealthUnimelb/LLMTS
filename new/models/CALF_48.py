...
class enc_mtan(nn.Module):
    ...
    def __init__(self, input_dim, query, nhidden=16,
        ...
        # LSTM
        self.local_lstm = nn.LSTM(input_size=self.nhidden, hidden_size=self.nhidden, batch_first=True, bidirectional=True)
    ...
    def forward(self, x, time_steps):
        ...
        # lstm
        lstm_input = out_patches.view(batch_size * self.num_patches, self.patch_len, self.nhidden)
