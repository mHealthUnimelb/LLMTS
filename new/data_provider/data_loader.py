...
class Dataset_ECG(Dataset):
    ...
    #     self.y_data = mode_labels.reshape(num_samples * num_segments)
    #
    #     # reshape y_data to (num_samples * num_segments, 1)
...
class Dataset_MIMIC(Dataset):
    def __init__(self, args=None, root_path=None, dataset='MIMIC', device=torch.device("cpu"), q=0, upsampling_batch=False):
        self.data_objects = get_data(args, dataset, device, q, upsampling_batch)
...
class Dataset_activity(Dataset):
    def __init__(self, args=None, root_path=None, dataset='activity', device=torch.device("cpu"), q=0, upsampling_batch=False):
        self.data_objects = get_data(args, dataset, device, q, upsampling_batch)
