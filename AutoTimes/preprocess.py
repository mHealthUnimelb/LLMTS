...
from data_provider.data_loader import Dataset_Preprocess, Dataset_Preprocess_ECG
...
if __name__ == '__main__':
    ...
    parser.add_argument('--token_len', type=int, default=16, help='token length')
    ...
    assert args.dataset in ['ETTh1', 'electricity', 'weather', 'traffic', 'ECG']
    if args.dataset == 'ETTh1':
        ...
        seq_len = 2500
        data_set = Dataset_Preprocess_ECG(
            root_path='/data/gpfs/projects/punim2341/feixiangz/datasets/ECG/2500/', flag='train', data_path='ECG',
            size=[seq_len, 0, 0], training_flag=1)
    ...
    print(result.shape)
    torch.save(result, save_dir_path + f'/{args.dataset + data_set.data_path}.pt')
