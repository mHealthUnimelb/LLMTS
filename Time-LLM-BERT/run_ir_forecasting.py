...
from utils.tools_forecasting import del_files, EarlyStopping, adjust_learning_rate, vali, load_content
...
for ii in range(args.itr):
    ...
    data_config = Config(args)
    data_obj = load_forecasting_data(data_config)
    ...
    for epoch in range(args.train_epochs):
        ...
        vali_loss, vali_mae_loss = vali(args, accelerator, model, val_loader)
        test_loss, test_mae_loss = vali(args, accelerator, model, test_loader)
        accelerator.print(
