...
class Model(nn.Module):
    def __init__(self, configs, device):
        ...
        self.in_layer = Encoder_PCA(configs.dim, None, hidden_dim=configs.d_model,
                                    ...
                                    num_ca_heads=configs.num_ca_heads, prompt_embeddings=None, configs=configs)
    ...
    def classification(self, x, time_steps):
        ...
        # print("outputs_time shape: ", outputs_time1.shape) # (128, 128, 768)
        # print("outputs_text shape: ", outputs_text1.shape) # (128, 128, 768)
