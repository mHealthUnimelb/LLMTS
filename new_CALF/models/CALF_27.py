...
# after cross-attention, conctae them then pass into LLM
import torch
...
class Encoder_PCA(nn.Module):
    ...
    def forward(self, x, time_steps):
        ...
        time_scales_out = torch.cat(time_scales_out, dim=1)
        text_scales_out = torch.cat(text_scales_out, dim=1)

        return time_scales_out, text_scales_out
