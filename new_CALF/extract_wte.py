...
#     #          "Lemon", "Mountain", "Piano"]
#
#     words = ["Trend", "season", "down", "up", "cycle", "rise", "peak", "atility", "relation", "istence", "pattern", "shift", "position", "ir", "regular", "missing", "heart", "period", "happy", "echo", "arm", "key", "mint"]
#
#     # Load GPT-2 tokenizer and model
#     tokenizer = GPT2Tokenizer.from_pretrained("gpt2")
#     gpt2_model = GPT2Model.from_pretrained("gpt2")
