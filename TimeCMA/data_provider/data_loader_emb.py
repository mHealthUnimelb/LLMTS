...
class Dataset_ECG(Dataset):
    def __init__(self, root_path="/data/gpfs/projects/punim2341/feixiangz/datasets/ECG", flag='train', size=None, 
                 features='M', data_path='ECG', num_nodes=2,
                 target='OT', scale=True, inverse=False, timeenc=0, freq='h',
                 model_name="gpt2", seq_len=2500, training_flag=1):
        if training_flag == 1:
            # load data
            if flag == "train":
        ...
        self.data_stamp = np.arange(seq_len) / 250
        ...
        self.model_name = model_name
        self.embed_path = f"/data/gpfs/projects/punim2341/feixiangz/TimeCMA/Embeddings/{self.data_path}/{flag}/"
    ...
    def __getitem__(self, index):
        ...
        return self.x_data[index], self.y_data[index], self.data_stamp, None, embeddings
        # return seq_x, seq_y, seq_x_mark, seq_y_mark
