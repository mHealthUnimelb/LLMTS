...
class Dataset_ECG(Dataset):
    def __init__(self, root_path="/data/gpfs/projects/punim2341/feixiangz/CALF/datasets/ECG/", flag='train', size=None, data_path='ECG', patch_len=16, seq_len=2500, training_flag=1):
        if training_flag == 1:
            # load data
            if flag == "train":
