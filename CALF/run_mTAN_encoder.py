...
from exp.exp_ir_classification_mTAN_encoder import Exp_IR_Classification_mTAN_Encoder
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_encoder_heads', type=int, default=1, help='num of heads for the encoder')
    parser.add_argument('--num_ca_heads', type=int, default=8, help='num of heads for the cross attention module')
    ...
    if args.data_type == 'regular':
        ...
        if args.task_name == 'long_term_forecast':
            ...
            Exp = Exp_Anomaly_Detection
        elif args.task_name == 'classification_mTAN_encoder':
            Exp = Exp_IR_Classification_mTAN_Encoder
        else:
            Exp = Exp_Long_Term_Forecast
