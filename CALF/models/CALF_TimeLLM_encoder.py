...
class Model(nn.Module):
    def __init__(self, configs, device):
        ...
        self.in_layer = Encoder_PCA(configs.seq_len, word_embedding, hidden_dim=configs.d_model, patch_len=configs.patch_len, stride=configs.stride)

        self.num_patches = ((self.configs.seq_len + configs.stride - configs.patch_len) // configs.stride) + 1
