...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--data_dir', default='./data',
                                 help='Data directory')
        self.parser.add_argument('--root_path', type=str, default='./data/ECG/', help='root path of the data file')
        self.parser.add_argument('--data_path', type=str, default='ECG', help='data file')
        self.parser.add_argument('--seq_len', type=int, default=2500, help='sequence length')
        self.parser.add_argument('--training_flag', type=int, default=1, help="if training, choose 1. Otherwise 0.")
