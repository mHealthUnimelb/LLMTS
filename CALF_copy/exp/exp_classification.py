...
class Exp_Classification(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        self.visualize_embeddings(time_channedl_1_embedding, trues, title="dropped 80% time channel 1 token embedding",
                                  setting=setting)
        self.visualize_embeddings(time_channedl_2_embedding, trues, title="dropped 80% time channel 2 token embedding",
                                  setting=setting)

        self.visualize_embeddings(text_channel_1_embedding, trues, title="dropped 80% text channel 1 token embedding",
                                  setting=setting)
        self.visualize_embeddings(text_channel_2_embedding, trues, title="dropped 80% text channel 2 token embedding",
                                  setting=setting)
