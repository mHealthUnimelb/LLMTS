...
parser.add_argument('--data_split_path', default='', type=str)
    ...
    for missing_ratio in missing_ratios:
        ...
        if args.dataset == 'P12':
            ...
            all_split_path = ['./data/P19data/splits/phy19_split1_new.npy',
                              ...
                              './data/P19data/splits/phy19_split3_new.npy',
                              './data/P19data/splits/phy19_split4_new.npy',
                              './data/P19data/splits/phy19_split5_new.npy']
        elif args.dataset == 'PAM':
            all_split_path = ['./data/PAM_split_1.npy', './data/PAM_split_2.npy', './data/PAM_split_3.npy',
                              './data/PAM_split_4.npy', './data/PAM_split_5.npy']
        else:
            all_split_path = None
        ...
        for r in range(num_runs):
            ...
            if all_split_path is not None:
                args.data_split_path = all_split_path[r]
            else:
                args.seed = [42, 12, 123, 2024, 2025][r]
            set_seed(args.seed)
            args.classif = True
            ...
            saved_model_path = f'mtand_{dataset}_{r}_best_model_val_aupr.pt'
            ...
            print(
                "TEST: test_acc: %.2f, aupr_test: %.2f, auc_test: %.2f, auc_precision: %.2f, auc_recall: %.2f, auc_F1: %.2f\n" % (
                    test_acc * 100, test_aupr * 100, test_auc * 100, test_precision * 100, test_recall * 100,
                    test_F1 * 100))
