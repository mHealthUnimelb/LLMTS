...
from utils.tools import EarlyStopping, adjust_learning_rate, visual,adjust_model, one_hot
...
class Exp_Classification(object):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            vali_loss, vali_accuracy, vali_auprc = self.vali(self.vali_data, self.vali_loader, self.criterion)
            self.vali_losses.append(vali_loss)
            self.vali_accuracies.append(vali_accuracy)
            self.vali_auprcs.append(vali_auprc)

            test_loss, test_accuracy, test_auprc = self.vali(self.test_data, self.test_loader, self.criterion)
