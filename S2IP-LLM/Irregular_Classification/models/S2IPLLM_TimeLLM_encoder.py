...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if self.task_name == 'long_term_forecast':
            ...
            self.in_layer = PatchEmbedding(configs.d_model, self.patch_size, self.stride, configs.dropout)
    ...
    def classify(self, x_enc, x_mark_enc=None, x_dec=None, x_mark_dec=None):
        ...
        pre_prompted_embedding, n_vars = self.in_layer(x_enc)  # map 3(decomp) * patch_size to llm embedding_dim
